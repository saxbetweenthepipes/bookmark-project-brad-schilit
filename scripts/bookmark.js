...
const bookmarkList = (function() {
    ...
    function handleFilter() {
        // event handler for rating filter
    ...
    function handleExpandBookmark() {
        // event listener for handling the expanded information of each bookmark
    ...
    function generateBookmarkString(bookmarks) {
        ...
        const items = bookmarks
            .filter(item => item.rating >= store.sortNumber)
            .map(item => generateBookmarkElement(item));
